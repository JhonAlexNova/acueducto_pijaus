                            ...
                            <thead class="cabecera-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div style="text-align: left;position: absolute; padding: 0 14px">
                                                <span><strong class="frase">{{Auth::user()->frase}}</strong></span> 
                                        </div>

                                        
                                    </td>
                                    <td class="text-center;" style="padding-left: 10px; width: 24%; padding-bottom:15px;">
                            ...
                            <tr>
                                <td style="width: 150px; padding: 0" rowspan="111">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        var mes1 = valores_consumo[1]['consumo'];
                                        var mes2 = valores_consumo[2]['consumo'];
                                        var mes3 = valores_consumo[3]['consumo'];
                                        var mes4 = valores_consumo[4]['consumo'];
                                        var mes5 = valores_consumo[5]['consumo'];
                                        var mes6 = valores_consumo[6]['consumo'];
                                        ...
                                        data: {
                                            labels: [
                                                ...
                                                valores_consumo[6]['periodo']+'/'+valores_consumo[6]['anno']
                                            ],
                                            datasets: [{
                                                label: 'Consumo mes',
                                ...
                                <td style="padding-left:20px; padding-top:10px !important"> <?php
                                    ...
                                    $valor_factura_basico =  $valor_consumo - $subsidio_consumo;
                                            if($id_nivel==11 || $id_nivel==12 ){
                                                ...
                                                echo number_format($valor_consumo,0);
                                            }else{
                            ...
                            <tr>
                                ...
                                <td style="padding-left:20px; padding-top:10px !important">
                                    <b>
                                        ...
                                        <?php
                                            $total_factura = $total_cargo + $valor_factura_basico;
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <td style="padding-left:30px; !important"> <b><?php $total_pagar = $total_factura + $c['saldo_anterior'] + $otros_cobros; echo number_format($total_pagar,0); ?></b>

                                @if($c['cantidad_facturas']>=3)
                                    <span class="text-danger corte-recibo"><b>PARA CORTE</b></span>
                                @endif
                                </td>
                            </tr>
                        </thead>
                    ...
                    <table style="margin-left: 10px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding-left:2px; padding-top:15px !important">
                                            <b>
                                                <?php
                                                    $total_factura = $total_cargo + $valor_factura_basico;
                                                    echo number_format($total_factura,0);
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left:2px; color:red; padding-top:10px !important">
                                            <b>
                                                <?php
