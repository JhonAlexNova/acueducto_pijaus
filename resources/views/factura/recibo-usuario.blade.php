...
<div class="container">
    <div class="row align-items-center justify-content-center" style="background-color: white;">
        ...
        <div class="col-md-3 row align-items-center justify-content-center title-reporte reporte">
            <p class=" text-center" style="margin-top:20px"><h4>Reportes Facturas</h4></p>
        </div>
        ...
        @foreach($consumo as $d => $c)
            ...
            <div class="col-xs-12 col-md-6" style="height: 1511px !important">
                <div class="recibo">
...
@if(!empty($_REQUEST['print']))
    ...
    <script>
        ...
        setTimeout(function () { $('.btn, .title-reporte').show(); }, 2000);
    </script>
@endif
